    ...
    async function fetchData() {
      try {
        const [cartResponse, favoritesResponse, itemsResponse] = await Promise.all([
          axios.get('https://62ac2393bd0e5d29af1b6637.mockapi.io/cart'),
          axios.get('https://62ac2393bd0e5d29af1b6637.mockapi.io/favorites'),
          axios.get('https://62ac2393bd0e5d29af1b6637.mockapi.io/items'),
        ]);
  ...
  const onAddToCart = async (obj) => {
    try {
      ...
      if (findItem) {
        ...
        await axios.delete(`https://62ac2393bd0e5d29af1b6637.mockapi.io/cart/${findItem.id}`);
      } else {
        setCartItems((prev) => [...prev, obj])
        const {data} = await axios.post('https://62ac2393bd0e5d29af1b6637.mockapi.io/cart', obj);
